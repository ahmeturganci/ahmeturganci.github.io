// Complete list of Turkish provinces with coordinates
const turkeyProvinces = {
  visited: [
    // Gezdiğiniz illeri buraya ekleyin
    // Örnek: { name: 'İzmir', lat: 38.4237, lon: 27.1428, visits: 1 },
    { name: 'İzmir', lat: 38.4237, lon: 27.1428, visits: 1 },
    { name: 'İstanbul', lat: 41.0082, lon: 28.9784, visits: 1 },
    { name: 'Ankara', lat: 39.9334, lon: 32.8597, visits: 1 },
  ],
  notVisited: [
    ...
    { name: 'Bolu', lat: 40.7339, lon: 31.6061 },
    ...
    { name: 'Elazığ', lat: 38.6748, lon: 39.2228 },
